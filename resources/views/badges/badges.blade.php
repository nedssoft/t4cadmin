                ...
                <div class="panel-body">
                 ...
                 <div class="table-responsive">
                  <table class="table">
                    ...
                    <td>
                    <a  href='badge/delete/'>Delete</a>
                    <a href='badge/update/'>Update </a>
                    </td>
                    </tr>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body col-md-12">
        <p>Fields marked with * are required</p>
         ...
         <p><div class="col-md-6">Points : </div><div class="col-md-6"><input class="form-control" type="text" name="email"></div></p>
